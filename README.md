# vl-show-on-checked
![GitHub issues](https://img.shields.io/github/issues-raw/milieuinfo/webcomponent-vl-ui-show-on-checked) ![GitHub pull requests](https://img.shields.io/github/issues-pr-raw/milieuinfo/webcomponent-vl-ui-show-on-checked) ![GitHub release (latest SemVer)](https://img.shields.io/github/v/release/milieuinfo/webcomponent-vl-ui-show-on-checked)
Gebruik de show on checked component om een element te tonen of verbergen wanneer men een checkbox of radio button (de)selecteert.

## Installatie
```
npm install --save vl-ui-show-on-checked
```

## API
De [API](https://webcomponenten.omgeving.vlaanderen.be/doc/Vlshow-on-checked.html) bevat een overzicht van de ondersteunde attributen en een beschrijving van de beschikbare functies.

## Demo
De [demo](https://webcomponenten.omgeving.vlaanderen.be/demo/vl-show-on-checked.html) pagina bevat een overzicht van de mogelijkheden met code voorbeelden. Lokaal opstarten kan met onderstaand [NPM](https://www.npmjs.com) script.
```
npm run demo
```
...
## Versionering
We gebruiken [Semantic Versioning](https://semver.org) en voorzien elke release van release notes, zie een overzicht van de [releases](https://github.com/milieuinfo/webcomponent-vl-ui-show-on-checked/releases).
...
## Credits
Zie de lijst van [ontwikkelaars](https://github.com/milieuinfo/webcomponent-vl-ui-show-on-checked/graphs/contributors) die meegewerkt hebben aan de webcomponent.
